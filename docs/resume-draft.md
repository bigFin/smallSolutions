...
Technical leader, systems architect, and applied researcher working across embedded systems, analytics, instrumentation, and production operations. I do my best work where technically complex programs need to become durable operating systems: low-power hardware in the field, analytical and data pipelines, plant production systems, and experimental programs that need clearer constraints, better feedback loops, and stronger operational footing.

## Core Areas

- Embedded systems, instrumentation, and low-power hardware
- Applied analytics, data architecture, and decision-support systems
- Controlled-environment agriculture, tissue culture, and process development
- Analytical chemistry workflow design and method development
- Technical leadership across R&D, operations, and production systems

## Selected Experience

### Co-Founder
**Avenue Intelligence** | Vancouver, BC | January 2023-Present

- Built and advanced a pedestrian sensing and analytics platform spanning ultra-low-power embedded devices, communications, contextual prediction, and production data systems
- Developed privacy-preserving sensing hardware and supporting analytics for real-world deployments with weak connectivity and demanding field constraints
- Led platform evolution from prototype systems toward object-storage-first data architecture, analytical workloads with ClickHouse and DuckDB, and more durable orchestration patterns
- Supported executive, technical, scientific, and business development work across product, IP, and deployment strategy
...
- C/C++ for embedded systems, Python, R
- Linux, NixOS, Docker, AWS
- ClickHouse, DuckDB, PostgreSQL, InfluxDB, MongoDB
- Grafana, Tableau, Power BI

### Hardware and design

- PCB design and fabrication with KiCad and Eagle
- ESP32 and related embedded platforms
- Fusion 360 and 3D-printed component design
- Environmental controls, fertigation, HVAC, and custom automation systems

### Scientific and operational work
...
- Controlled-environment agriculture, photobiology, and process optimization
...
- Volunteer experience is omitted here to keep the resume focused on technical and operational work.
- If needed, this can be split into two versions:
  - a systems/engineering version for infrastructure, embedded, and applied analytics roles
  - a plant science / applied biotech version for cultivation, propagation, and technical operations roles
