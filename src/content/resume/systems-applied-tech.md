...
summary: "Resume emphasizing distributed sensing, embedded systems, analytics, and technical leadership."
...
### Avenue Intelligence | Co-Founder | Jan 2023-Present

**Pedestrian Traffic Sensing & Analytics**
- Low-power sensing hardware for field deployments with weak connectivity.
- Data architecture utilizing object-storage, ClickHouse, and DuckDB for analytical workloads.
- Privacy-preserving firmware and communications behavior.
- Prediction systems integrating field signals with geospatial data.
...
- Technical workflows connecting experimental work and production decisions.
...
- ESP32 and low-power embedded platforms
- Fusion 360, 3D-printed component design
